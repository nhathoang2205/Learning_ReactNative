...
// Main Home Screen: Pending
export default class HomePendingScreen extends React.Component {
          ...
          <View style={{ flex: 5, }}>
            ...
            <View style={{ flex: 4, flexDirection: 'row', alignItems: 'center', }}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => {}}>
                  <Text style={{ fontSize: 18, color: 'rgba(40, 41, 43, 0.5)', }}>26</Text>
              ...
              <TouchableOpacity 
                style={{ flex: 1,alignItems: 'center', }} 
                onPress={() => {}}>
                  <Text style={{ fontSize: 18, color: 'rgb(255, 168, 183)', }}>18</Text>
