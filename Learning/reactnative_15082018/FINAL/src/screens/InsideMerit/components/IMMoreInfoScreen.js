...
// Main Inside merit Screen: More info
export default class IMMoreInfoScreen extends React.Component {
          ...
          <View style={{ flex: 11, }}>
            ...
            <View style={{ flex: 1, flexDirection: 'row', }}>
              ...
              <View style={{ flex: 2, justifyContent: 'center', }}>
                <Text style={{ paddingLeft: 25, color: 'rgb(40, 41, 43)', }}>PHOTOS</Text>
              </View>
            </View>
